...
def detail(request, name):
    ...
    return render(request, 'front/detail.html',{'shownews':shownews,'name':article_var, 'News':news, 'cat': cat,'subcat':subcat, 'lastnews':lastnews,'popularnews':popularnews,'popularnews2':popularnews2,"tags":tags,'trending':trending,'code':code,'comments':comments, 'comment_count':comment_count,'link':link})
...
def all_news_all_cats(request):
    ...
    return render(request, 'front/all_news_all_cat.html',{'name':article_var, 'News':news, 'cat': cat,'subcat':subcat, 'lastnews':lastnews, 'popularnews2':popularnews2, 'trending':trending,'lastnews2':lastnews2,'allnews':allnews})
